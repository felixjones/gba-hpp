...
struct alignas(uint16) key_type {
    bool a : 1;
    bool b : 1;
    bool select : 1;
    bool start : 1;
...
namespace key {
    ...
    static constexpr auto a = field_of::boolean<key_type, 0>();
    static constexpr auto b = field_of::boolean<key_type, 1>();
    static constexpr auto select = field_of::boolean<key_type, 2>();
    static constexpr auto start = field_of::boolean<key_type, 3>();
    static constexpr auto right = field_of::boolean<key_type, 4>();
    static constexpr auto left = field_of::boolean<key_type, 5>();
    static constexpr auto up = field_of::boolean<key_type, 6>();
    static constexpr auto down = field_of::boolean<key_type, 7>();
    static constexpr auto r = field_of::boolean<key_type, 8>();
    static constexpr auto l = field_of::boolean<key_type, 9>();
